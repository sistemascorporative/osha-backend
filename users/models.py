...
class EstudianteUser(AbstractBaseUser, PermissionsMixin): #UserAccount
    ...
    userciu = models.CharField(verbose_name="Ciudad", db_column='UserCiu', max_length=50, blank=True, null=True)
    userdir = models.CharField(verbose_name="Dirección", db_column='UserDir', max_length=100, blank=True, null=True)
