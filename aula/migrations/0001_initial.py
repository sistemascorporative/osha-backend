    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curnomeng', models.CharField(db_column='CurNomEng', default='', max_length=80, verbose_name='Nombre en Inglés')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pronom', models.CharField(db_column='ProNom', max_length=100, verbose_name='Nombre de Grado')),
                ('pronomeng', models.CharField(blank=True, db_column='ProNomEng', default='', max_length=100, verbose_name='Nombre de Grado en inglés')),
                ('prodip', models.CharField(blank=True, db_column='ProDip', default='', max_length=100, verbose_name='Nombre de Diploma')),
                ('prodipeng', models.CharField(blank=True, db_column='ProDipEng', default='', max_length=100, verbose_name='Nombre de Diploma en inglés')),
