...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Estudiante',
            fields=[
                ('estcod', models.AutoField(db_column='EstCod', primary_key=True, serialize=False)),
                ('estnom', models.CharField(db_column='EstNom', max_length=60)),
                ('estape', models.CharField(db_column='EstApe', max_length=60)),
                ('estdocide', models.CharField(db_column='EstDcIde', max_length=50)),
                ('estema', models.EmailField(db_column='EstEma', max_length=50)),
                ('estpai', models.CharField(blank=True, db_column='EstPai', max_length=50)),
                ('estciu', models.CharField(blank=True, db_column='EstCiu', max_length=50)),
                ('estdir', models.CharField(blank=True, db_column='EstDir', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matcurcod', models.ForeignKey(db_column='MatCurCod', on_delete=django.db.models.deletion.DO_NOTHING, to='aula.curso', verbose_name='Codigo Curso')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notcurestregcod', models.ForeignKey(db_column='NotCurEstRegCod', on_delete=django.db.models.deletion.DO_NOTHING, to='aula.estadoregistro', verbose_name='Codigo EstReg')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notprocurcod', models.ForeignKey(db_column='NotProCurCod', on_delete=django.db.models.deletion.DO_NOTHING, to='aula.curso', verbose_name='Codigo Curso')),
                ...
                ('notproestregcod', models.ForeignKey(db_column='NotProEstRegCod', on_delete=django.db.models.deletion.DO_NOTHING, to='aula.estadoregistro', verbose_name='Codigo EstReg')),
            ],
            options={
